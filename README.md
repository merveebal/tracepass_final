...
* **Veri Yönetimi:** REST API & MockAPI
* **HTTP Yönetimi:** `http` package
* **State Yönetimi:** `flutter_dotenv` (Güvenli API Yönetimi)
...
1. Bu depoyu klonlayın: `git clone https://github.com/merveebal/tracepass_final.git`
2. Proje dizinine gidin: `cd tracepass_final`
3. Bağımlılıkları yükleyin: `flutter pub get`
4. `.env` dosyanızı oluşturun ve API anahtarınızı ekleyin.
5. Uygulamayı başlatın: `flutter run`
